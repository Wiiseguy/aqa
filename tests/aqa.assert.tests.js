...
test('deepEqual', t => {
    ...
    t.deepEqual(new Set([1, 2, 3]), [1, 2, 3]);
});
...
test('notDeepEqual', t => {
    ...
    t.notDeepEqual(new Set([1, 2, 3]), [1, 2, 4]);
});
...
test('throwsAsync', async t => {
    ...
    let error = await t.throwsAsync(async _ => {
...
test('Assert fail messages', async t => {
    ...
    t.is(
        Color.strip(e.message),
        'Difference found at path: (root)\n' +
            "-   'b\\n' +\n" +
            "  'c\\n' +\n" +
            "  'd\\n' +\n" +
            "+   'c\\n' +\n" +
